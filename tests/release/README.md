...
- `tests/test_v050_supported_alpha_profile_baseline.py`: Deterministic verification of the v0.5.0 synthetic profile, confidentiality, NFR placeholders, and retained holds (`ARC-V050-PROF-001` / `V050-E003`).
- `tests/test_v050_test_assurance_plan.py`: Deterministic verification of the v0.5.0 synthetic test, assurance, UAT-preparation, support, recovery, and evidence-plan boundary (`ARC-V050-ASSURE-001` / `V050-E004`).
