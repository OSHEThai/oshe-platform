...
The provider identity is `gemini` and its display name is Gemini. The supported static context entry points are exactly those listed in the frontmatter. They convey context only and grant no execution authority.
