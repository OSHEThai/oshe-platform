...
Freeze new work on the provider, preserve active state, reroute eligible tasks without weakening gates, and notify the Project Management Agent and Sole Human Owner when required.
