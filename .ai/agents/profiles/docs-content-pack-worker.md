---
profile_id: docs-content-pack-worker
version: 1.0.0
...
# Documentation and Content Pack Specialist Profile

## Purpose

Documentation, content pack drafts, changelog, and migration guides.

## Write Scope

documentation and content paths, restricted by the task write lease.
