...
description: >
  Implement repeatable end-to-end tests across API, UI, database, object storage, and background jobs. Use this skill when the assigned task explicitly involves this capability.
license: Proprietary
metadata:
  oshe-version: "0.1.0"
---
...
Implement repeatable end-to-end tests across API, UI, database, object storage, and background jobs.
