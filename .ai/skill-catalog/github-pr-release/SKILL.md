...
description: >
  Create draft PR metadata, changeset, checks summary, release note draft, and evidence references. Use this skill when the assigned task explicitly involves this capability.
license: Proprietary
metadata:
  oshe-version: "0.1.0"
---
...
Create draft PR metadata, changeset, checks summary, release note draft, and evidence references.
