---
name: checklist-workflow-authoring
description: >
  Author versioned checklist, workflow, rules, evidence requirements, findings, and evaluation logic. Use this skill when the assigned task explicitly involves this capability.
license: Proprietary
metadata:
  oshe-version: "0.1.0"
---
...
Author versioned checklist, workflow, rules, evidence requirements, findings, and evaluation logic.
