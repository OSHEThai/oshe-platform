...
name: task-graph
description: >
  Decompose a mission into an acyclic dependency graph with non-overlapping write scopes. Use this skill when the assigned task explicitly involves this capability.
license: Proprietary
metadata:
  oshe-version: "0.1.0"
---
...
Decompose a mission into an acyclic dependency graph with non-overlapping write scopes.
