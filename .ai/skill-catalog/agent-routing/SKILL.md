...
name: agent-routing
description: >
  Select role, provider, model, effort, tool profile, and fallback under quota and data constraints. Use this skill when the assigned task explicitly involves this capability.
license: Proprietary
metadata:
  oshe-version: "0.1.0"
---
...
Select role, provider, model, effort, tool profile, and fallback under quota and data constraints.
