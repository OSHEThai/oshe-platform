...
name: docs-from-diff
description: >
  Update user, admin, API, migration, ADR, and changelog documentation from an accepted diff. Use this skill when the assigned task explicitly involves this capability.
license: Proprietary
metadata:
  oshe-version: "0.1.0"
---
...
Update user, admin, API, migration, ADR, and changelog documentation from an accepted diff.
