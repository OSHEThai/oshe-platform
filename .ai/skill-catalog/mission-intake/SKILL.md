...
name: mission-intake
description: >
  Turn an approved issue or request into a complete mission draft with scope, non-goals, risk, and human decisions. Use this skill when the assigned task explicitly involves this capability.
license: Proprietary
metadata:
  oshe-version: "0.1.0"
---
...
Turn an approved issue or request into a complete mission draft with scope, non-goals, risk, and human decisions.
