...
name: code-review
description: >
  Review final diff against requirements, architecture, error handling, observability, and tests. Use this skill when the assigned task explicitly involves this capability.
license: Proprietary
metadata:
  oshe-version: "0.1.0"
---
...
Review final diff against requirements, architecture, error handling, observability, and tests.
